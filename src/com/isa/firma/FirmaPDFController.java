...
public class FirmaPDFController {
    ...
    public PDFFirma generarApariencia(  ) throws AppletException{
        try {
            ...
            infofirma.setCedula(ActualCertInfo.getInstance().getCedula());
        ...
        try {
            ...
            if (infoFirma.isApariencia()){
                ...
                String textofirma = "Firmado digitalmente por: " + infoFirma.getFirmante() + 
                                    "\nCédula: " + infoFirma.getCedula() +
                                    "\nFecha: " + Utiles.DATE_FORMAT_SIGN.format(new Date()) + 
                                    "\nMotivo: Prueba de Recepción " + 
