...
public class Utiles {
    ...
    public static final SimpleDateFormat DATE_FORMAT_SIGN = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss");
    ...
    public static String getDNI( String nombre ){
        String[] arr = nombre.split(",");
        for ( int i = 0; i < arr.length; i++ ){
            if( arr[i].startsWith(" SERIALNUMBER=") || arr[i].startsWith("SERIALNUMBER=")){
                ...
                String serialnumber = arr[i].split("=")[1];
                String cedula = "";
                if (serialnumber.startsWith("DNI ")){
                    cedula = serialnumber.replace("DNI ", "");
                }
                else if (serialnumber.startsWith("DNI")){
                    cedula = serialnumber.replace("DNI", "");
                }
                return cedula;
            }
