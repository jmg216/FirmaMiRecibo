...
public class UtilesMsg {
    ...
    public static String CERTIFICADO_OBTENIDO_OK = "Certificado obtenido correctamente";
    ...
    public static String ERROR_CERT_VACIO = "No se pueden encontrar los certificados del dispositivo";
